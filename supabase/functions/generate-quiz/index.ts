...
날짜를 시드로 사용하여 매일 다른 5개의 OX 퀴즈를 생성합니다.
퀴즈는 일반 상식, 과학, 역사, 문화 등 다양한 주제를 다룹니다.
각 퀴즈는 명확하고 흥미로우며, 정답이 분명해야 합니다.`
          },
          {
            role: "user",
            content: `${date} 날짜를 기반으로 5개의 OX 퀴즈를 생성해주세요. JSON 형식으로만 응답해주세요.`
          }
        ],
        tools: [
          {
